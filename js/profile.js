...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const profileFields = document.querySelectorAll('.profile-form input, .profile-form select .profile-form textarea');
    ...
    function validateAndSave(field) {
        ...
        switch(field.id) {
            ...
            case 'preferences':
                ...
                if (value.length > 300) {
                    isValid = false;
                    errorMessage = "Preferences cannot exceed 300 characters.";
                }
                if (value.length < 20) {
                    isValid = false;
                    errorMessage = "Preferences must consist of at least 20 characters.";
                }   
                break;
        }
